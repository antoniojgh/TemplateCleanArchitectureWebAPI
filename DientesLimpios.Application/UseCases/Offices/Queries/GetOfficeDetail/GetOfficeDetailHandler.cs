...
{
    public class GetOfficeDetailHandler(IApplicationDbContext db, ILogger<GetOfficeDetailHandler> logger) : IRequestHandler<GetOfficeDetailQuery, Result<OfficeDetailDTO>>
    {
